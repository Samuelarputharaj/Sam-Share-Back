...
const PASSWORD="WUvpDjHgTy8nv2XH"
const DB_NAME = "sam-share";   //  👈⬅️⬅️⬅️⬅️ TODO : update your data base name
const URI = `mongodb+srv://${USERNAME}:${PASSWORD}@samplecluster.sf3sp9g.mongodb.net/${DB_NAME}`;
